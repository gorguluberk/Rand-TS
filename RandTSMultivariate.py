...
class RandTSMultivariate():
    ...
    def fit(self, train, train_labels,ndims):
        self.train = train
        ...
        for b in batch_list2:
            ...
            represent_train, train_id = prepare_data_new_multivariate(self.train,self.ndim,mode=self.method)
    ...
    def predict(self,test,test_labels = None):
        ...
        for b in batch_list2:
            ...
            represent_test, test_id = prepare_data_new_multivariate(self.test,self.ndim,mode=self.method)
    ...
    def selectParameters(self, train, train_labels, ndims, param_kwargs={'depth_cv':[3,5,10], 'ntree_cv':[100], 'rep_num':1, 'method_cv':['l','d']}):
        self.ndim = ndims
        self.train = train
        self.labels_train = train_labels
                            ...
                            for is_terminal in term_cv: 
                                for n in [0]:
                                    ...
                                    for b in batch_list:
                                        ...
                                        trainbow,randTrees,trainRep,train_id = learn_representation_sparse_new(represent_train,self.labels_train, train_id, self.depth, int(self.ntree/len(batch_list)),rep*1000+counter, True,normal=False)
                                        counter = counter +1
